...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div>
            <form action="{{ url("admin/storeeditdata") }}" method = "post" style="margin-left: 90px; margin-top: 50px; width: 30%; font-family:'GothamRounded-Medium';">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Masukkan Nama Mitra" name="nama_mitra" value="{{data.nama_mitra}}" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Masukkan PIC Mitra" name="pic_mitra" value="{{data.pic_mitra}}" required>
                </div>
